...
namespace NewsBreak.Application.Infrastructure.Factories
{
    ...
    internal static class DelegateFactory
    {
        ...
        private static ConcurrentDictionary<Type, object> s_FactoryFunctions = new ConcurrentDictionary<Type, object>();
